...
---
## What does bisulfite treatment do to DNA?

* Bisulfite treatment converts unmethylated `C` to `U`, resulting the downtream PCR products to reflect the presence of `T` instead of `C` on the forward strand and `A` instead of `G` on the reverse strand.
...
```{bash eval=FALSE}
LOGDIR=$SCRATCH/Logs; SCRIPTDIR=$SCRATCH/Scripts
cd $SCRIPTDIR
BAMDIR=$SCRATCH/trimmedAlignedBamsChr22
